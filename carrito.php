...
<?php
            ...
            <a href="process-checkout.php"><button class="btn-action" name="check_out">Proceder con el pago</button></a>
            </div>
<?php
